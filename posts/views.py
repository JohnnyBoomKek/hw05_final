...
def profile(request, username):
    ...
    if request.user.is_authenticated:
        if request.user.follower.filter(author=author).exists():
            following = True
    context = {"user": user, "posts_cnt": posts_cnt, "page": page, "paginator": paginator,
               'author': author, 'following': following, 'NotMyPageFlag': NotMyPageFlag}
...
def post_view(request, username, post_id):
    ...
    context = {'user': user, "post": post, 'posts_cnt': posts_cnt, 'author': post.author,
               'comments': comments, 'form': form, 'comment_cnt': comment_cnt}
